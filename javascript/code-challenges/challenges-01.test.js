...
const addValues = (inputArr, value) => {
  inputArr.push(value);
};

const addNumbers = (num, inputArr, times, callback) => {
  for (let i = 0; i < times; i++) {
    callback(inputArr, num);
  }
  return inputArr;
};
