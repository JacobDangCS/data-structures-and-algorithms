...
const repeatedWord = require('./challenge-31');

describe('Testing repeatedWord', () => {

  test('Returns a string that is repeated', () => {
    let string = 'Here I have strings that I have created for this test';
    let results = repeatedWord(string);
    expect(results).toEqual('I');

  });

  test('Can handle example2 from assignment', () => {
    ...
    let results = repeatedWord(string);
    expect(results).toEqual('it');
  });

  test('Can handle example3 from assignment', () => {
